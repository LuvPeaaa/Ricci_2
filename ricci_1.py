...
def build_graph(features, timestamps, distance_method='euclidean', epsilon=1.0):
    """
...
def visualize_graph(G, title="Time Series Graph"):
    ...
    # Draw edges with color based on Ricci curvature
    edges = G.edges()
...
def analyze_time_series(file_path, window_size=10, step_size=1, 
                        distance_method='euclidean', epsilon=1.0, visualize=True):
    """
...
if __name__ == "__main__":
    ...
    file_path = 'D:\\1.haidang\\data\\processed_stock.csv'
